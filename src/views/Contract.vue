...
const currentRows = computed(() => {
  if (selectedTable.value === 'approved') return filteredRowsApproved.value;
  if (selectedTable.value === 'waiting') return filteredRowsWaiting.value;
  return filteredRowsDeclined.value;
});
...
<template>
  ...
  <Table
    ...
    :firstCol="isRoleHrdi"
    :headers="{
      head: ['Ernp ID', 'Full Name', 'Program', 'University', 'Duration', 'Salary', 'Contract Amount', 'Status','Actions'],
  ...
  <div v-if="showStudent " class="fixed inset-0 ml-40 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-lg shadow-lg gap-3 flex flex-col space-between-[24px] p-6 w-[877px]">
              ...
              <form  class="grid grid-cols-1 gap-y-4 gap-x-6 md:grid-cols-3 md:gap-x-8">
  <!-- ERNP ID -->
 ...
 <!-- University Name -->
 <div class="col-span-1">
    <label for="programName" class="block text-sm font-medium text-gray-700">University</label>
    <input 
  ...
  <div class="col-span-1">
    <label for="programName" class="block text-sm font-medium text-gray-700">Contract Status</label>
    <input 
  ...
  <!-- Duration -->
  <div class="col-span-1">
    <label for="duration" class="block text-sm font-medium text-gray-700">Approved Date</label>
    <input 
  ...
  <!-- University Name -->
  <div class="col-span-1">
    <label for="totalSalary" class="block text-sm font-medium text-gray-700">Region</label>
    <input 
    ...
    <label for="totalSalary" class="block text-sm font-medium text-gray-700">Woreda</label>
    <input 
    ...
    <label for="totalSalary" class="block text-sm font-medium text-gray-700">City</label>
    <input 
    ...
    <label for="totalSalary" class="block text-sm font-medium text-gray-700">Subcity</label>
    <input 
    ...
    <label for="totalSalary" class="block text-sm font-medium text-gray-700">House Number</label>
    <input 
  ...
  <div v-if="selectedTable === 'waiting'">
  Waiting
  <Table
    :Fallback="TableRowSkeleton"
    :firstCol="isRoleHrdi"
  ...
  <div v-if="selectedTable === 'declined'">
  Declined
  <Table
    :Fallback="TableRowSkeleton"
    :firstCol="isRoleHrdi"
