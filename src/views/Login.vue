...
<template>
  <div class="grid grid-cols-2 h-screen">
    <div
      class="h-screen flex flex-row justify-center items-center bg-[#21618C]"
    >
    ...
    >
      <div class="w-full max-w-md">
        ...
        <p class="text-sm text-gray-400">
          ...
          <h2 class="text-lg font-bold text-gray-800 font-dm-sans">Welcome</h2>
