...
import {
  getAllUniversities,
  getAllStudents,
} from '@/features/university/api/uniApI';
...
function updateItem() {
  ...
  if (index !== -1) items.value.splice(index, 1, currentItem.value); // Update the item in the array
...
<template>
  <div class="bg-[#FBFBFB] p-5 relative">
      ...
      <div class="flex-1 h-full p-4 flex flex-col justify-center">
        <div class="bg-white rounded p-4 flex flex-col gap-2">
          ...
          <div class="h-10 rounded overflow-hidden bg-[#b1afaf] relative">
            <div
              ref="progress"
              class="progress absolute rounded w-0 top-0 left-0 inset-0 bg-secondary"
            />
          </div>
        </div>
      </div>
    ...
    <div>
      ...
      >
        <div class="flex items-center justify-center min-h-screen bg-gray-100">
          ...
          />
          <div
            class="flex items-center justify-center min-h-screen bg-gray-50 py-4"
          >
            <div
              class="fixed inset-0 bg-gray-600 bg-opacity-50 transition-opacity"
              aria-hidden="true"
            ...
            <div
              class="relative bg-white rounded-lg shadow-lg w-[1500px] overflow-hidden transform transition-all sm:max-w-2xl mx-4"
            >
              <form @submit.prevent="saveStudent">
                <div class="bg-white px-4 py-3">
                  <div class="text-center mb-4">
                    <h3
                      class="text-lg text-left font-semibold leading-6 text-gray-900"
                    >
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-3">
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="empId"
                        v-model="studentDetail.firstName"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="empId"
                        v-model="studentDetail.fathersName"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        placeholder="Enter student employee ID"
                      />
                    ...
                    <div class="flex flex-col">
                      <label
                        ...
                        class="block text-sm font-medium text-gray-700"
                      >
                        grandFathersName</label
                      >
                      <input
                        id="empId"
                        v-model="studentDetail.grandFathersName"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        placeholder="Enter student employee ID"
                      />
                    ...
                    <div class="flex flex-col">
                      ...
                      <div class="flex items-center space-x-4">
                        ...
                        <select
                          id="countryCode"
                          v-model="studentDetail.countryCode"
                          class="block w-1/4 min-w-[80px] border border-gray-300 rounded-l-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm px-2"
                        >
                        ...
                        <input
                          id="phone"
                          v-model="studentDetail.phone"
                          type="tel"
                          class="block w-3/4 border border-gray-300 rounded-r-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="program"
                        v-model="studentDetail.birthDate"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="program"
                        v-model="studentDetail.duration"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        placeholder="Enter student program"
                      />
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="program"
                        v-model="studentDetail.totalSalary"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        placeholder="Enter student program"
                      />
                    ...
                    <div class="flex flex-col">
                      ...
                      <select
                        id="maritalStatus"
                        v-model="studentDetail.martialStatus"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      >
                    ...
                    <div class="flex flex-col">
                      ...
                      <input
                        id="program"
                        v-model="studentDetail.university"
                        type="text"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                        placeholder="Enter student program"
                      />
                ...
                >
                  <button
                    type="submit"
                    class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-600 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:ml-3 sm:w-auto"
                  >
                    Save
                  </button>
                  <button
    ...
    <div
      class="flex px-4 justify-between items-center bg-gray-100 rounded-lg shadow-md p-4"
    >
      <input
      ...
      <div class="flex items-center gap-6">
        <!-- Increased gap here -->
        <div
          class="bg-[#21618C] text-white flex items-center gap-2 font-dm-sans p-2 rounded-lg shadow-md transition duration-300 ease-in-out hover:bg-[#1A4D6D]"
        >
        ...
        <button
          v-if="file"
          class="rounded-lg bg-green-500 text-white py-2 px-4 shadow-md hover:bg-green-600 transition duration-300"
          @click="uploadFile"
        >
          Upload
        </button>
      ...
      <Table
        ...
        :headers="{
          ...
          row: [
            ...
            'universityCount',
            'studentCount',
            '	This are the new requested members...',
          ],
        }"
...
>
  Open
      ...
      >
        <div>
          <div
            class="relative w-full ml-[200px] my-10 bg-white border border-gray-300 rounded-lg shadow-md p-4"
          >
            <!-- Table Container -->
              ...
              >
                <thead>
                  <tr class="bg-gray-200 text-left border-b">
                    ...
                    <th class="p-2 w-[13px]">#</th>
                    <th class="p-2 w-[70px]">IHRS ID</th>
                    <th class="p-2 w-[208px]">Full Name</th>
                    <th class="p-2 w-[70px]">Gender</th>
                    <th class="p-2 w-[100px]">Program</th>
                    <th class="p-2 w-[100px]">Address</th>
                    <th class="p-2 w-[100px]">Email</th>
                    <th class="p-2 w-[100px]">Maritial Status</th>
                    <th class="p-2 w-[100px]">UniversityName</th>
                    <th class="p-2 w-[100px]">Program Name</th>
                    <th class="p-2 w-[70px]">Duration</th>
                    <th class="p-2 w-[66px]">Salary</th>
                    <th class="p-2 w-[84px]">Contract Amount</th>
                    <!-- <th class="p-2 w-[74px]">
                      Status
                    </th> -->
                  </tr>
            ...
            <div class="flex justify-end gap-4 mt-4">
              <button
                type="button"
                class="bg-[#21618C] text-white p-2 rounded hover:bg-[#1d5a80]"
                @click="updateItem"
              >
                Approve
              </button>
              <button
                type="button"
                class="bg-[#FF4040] text-white p-2 rounded hover:bg-[#d63031]"
                @click="closeModal"
              >
                Cancel
              </button>
