...
<template>
  <div class="flex bg-secondary w-full h-screen">
    <div :class="[open ? 'w-72' : 'w-12 show-title']"
      ...
      <button @click="open = !open"
        ...
        <icon :class="[open ? 'rotate-0' : 'rotate-180' ]" class="transition-transform duration-500 ease-in-out  w-7 h-7" name="md-menuopen-round" />
      </button>
    </div>
