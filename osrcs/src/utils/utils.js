...
export function getFileType(filename) {
  ...
  if (documentExtensions.includes(ext))
    return 'file'
  if (videoFileTypes.includes(ext))
    return 'video'
}
...
export function formatCurrency(currencyValue) {
  if ([undefined, null].includes(currencyValue))
    return
  const currencyFormat = new Intl.NumberFormat('am-ET', {
    style: 'currency',
    currency: 'ETB',
  }).format(Number.parseInt(currencyValue))
...
export function getAgeFormDate(date) {
  ...
  return Number.parseInt(now - age)
}
...
export const FREQUENCY = {
  IMMEDIATELY: { label: 'Immediately', values: '1.00 Hour/s' },
  ONCE_A_DAY: { label: 'Once a day', values: '1.00 Day/s' },
  THRICE_A_DAY: { label: 'Thrice a day', values: '3.00 Day/s' },
  FOUR_TIMES_A_DAY: { label: 'four times a day', values: '4.00 Day/s' },
  EVERY_2_HOURS: { label: 'Every 2 hours', values: '12.00 Day/s' },
  EVERY_3_HOURS: { label: 'Every 3 hours', values: '8.00 Day/s' },
  EVERY_4_HOURS: { label: 'Every 4 hours', values: '6.00 Day/s' },
  EVERY_6_HOURS: { label: 'Every 6 hours', values: '4.00 Day/s' },
  EVERY_8_HOURS: { label: 'Every 8 hours', values: '3.00 Day/s' },
  EVERY_12_HOURS: { label: 'Every 12 hours', values: '2.00 Day/s' },
  ON_ALTERNATIVE_DAYS: { label: 'On alternative days', values: '1.00 Day/s' },
  ONCE_A_WEEK: { label: 'Once a week', values: '1.00 Day/s' },
  TWICE_A_WEEK: { label: 'Twice a week', values: '2.00 Day/s' },
  THRICE_A_WEEK: { label: 'Thrice a week', values: '3.00 Day/s' },
  EVERY_2_WEEKS: { label: 'Every 2 weeks', values: '0.50 Day/s' },
  ONCE_A_MONTH: { label: 'Once a month', values: '1.00 Day/s' },
  FOUR_TIMES_A_DAY: { label: 'Four times a day', values: '5.00 Day/s' },
  FOUR_DAYS_A_WEEK: { label: 'Four days a week', values: '4.00 Day/s' },
  FIVE_DAYS_A_WEEK: { label: 'Five times a day', values: '5.00 Day/s' },
}
