...
<template>
  <ModalParent class="fixed top-0 left-1/3 flex w-2/3  p-4 mt-20  overflow-auto" v-slot="data" name="Search">
    <div class="flex flex-col gap-8 w-full bg-white p-2 rounded-lg">
      <div class="flex justify-between items-center">
        <p class="font-normal text-gray-400 text-base">Found 1 result for  “1000034”</p>
      ...
      <TablePrescribe
    :headers="{
      head: ['Medicine Name', 'Dosage Form', 'Strength', 'Description',  'Price', 'Status','Action'],
      row: ['medicineName', 'dosageFrom', 'stength', 'description', 'Price', 'Status']
    }"
    :rows="entries"
