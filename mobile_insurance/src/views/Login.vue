...
<template>
  <div class="w-full h-full flex place-items-center">
    <div :style="{
    }" class="relative bg-gradient-to-br from-gray-800 bg-primary h-full flex flex-col items-center flex-[2]">
    ...
    v-if="!refreshRequest.pending.value" class="flex-1 bg-gray-200 h-full shadow-md w-96 p-3 rounded-md flex justify-center flex-col gap-4">
