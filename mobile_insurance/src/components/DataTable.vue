...
<template>
  <div @scroll.self="checkScrollPos" class="max-h-full min-h-48 data-table-scrollbar relative rounded-md overflow-y-scroll">
    <div>
      <table class="w-full">
        <thead class="z-10 sticky top-0 bg-table-clr border-b-2 border-gray-300/30">
          <slot name="table-header">
            <tr>
              ...
              <th
                :class="[headers.includes('modify') ? 'last-header' : '']"
